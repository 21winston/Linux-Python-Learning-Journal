...
## The fix 
So ,I elevated my privilledges by typing `sudo`, then my command.To fix the UID issue, I had to manually fix the gruop ID first ,then the user ID using these commands :
```bash
